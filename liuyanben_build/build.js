...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ if (false) { (function () { var ReactHotAPI = require("D:\\reactWorkspace\\liuyanben-难叔\\node_modules\\react-hot-api\\modules\\index.js"), RootInstanceProvider = require("D:\\reactWorkspace\\liuyanben-难叔\\node_modules\\react-hot-loader\\RootInstanceProvider.js"), ReactMount = require("react/lib/ReactMount"), React = require("react"); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } try { (function () {
	...
	var _mes = __webpack_require__(169);

	var _mes2 = _interopRequireDefault(_mes);
	...
	var Main = function (_React$Component) {
		...
		function Main(props) {
			...
			var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(Main).call(this, props)); // 初始化state


			_this2.state = {
				dataArr: _this2.props.dataArr
			};
			return _this2;
		}
		...
		_createClass(Main, [{
			...
			value: function componentDidMount() {
				PubSub.subscribe(deleteItem, function (ev, data_id) {
					var _this = this;
					this.state.dataArr.forEach(function (item, index) {
						if (item.id == data_id) {
							_this.state.dataArr.splice(index, 1);
						}
					});
					(0, _util.store)("liuyanben", this.state.dataArr);
			...
			value: function render() {
				return _react2.default.createElement(
					"div",
					null,
					_react2.default.createElement(_mes2.default, { addItem: this.addItem.bind(this) }),
					_react2.default.createElement(_list2.default, { dataArr: this.state.dataArr })
				);
			}
		}]);
	...
	var dataArr = (0, _util.store)("liuyanben") || [];
	_reactDom2.default.render(_react2.default.createElement(Main, { dataArr: dataArr }), section);

	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("D:\\reactWorkspace\\liuyanben-难叔\\node_modules\\react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "index.jsx" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Mes = function (_React$Component) {
		_inherits(Mes, _React$Component);

		function Mes() {
			_classCallCheck(this, Mes);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(Mes).apply(this, arguments));
		}
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement("input", { type: "text", ref: "text_username", placeholder: "用户名", className: "input_tx" })
							)
						),
						_react2.default.createElement(
							"div",
							...
							_react2.default.createElement(
								...
								_react2.default.createElement("textarea", { rows: "6", ref: "text_content", placeholder: "留言内容", className: "input_tx" })
							)
						),
						_react2.default.createElement(
							"div",
							{ className: "field" },
							_react2.default.createElement("input", { type: "button", value: "提交", className: "btn_tijiao", onClick: this.addItemHand.bind(this) })
						)
					)
				);
			}
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("D:\\reactWorkspace\\liuyanben-难叔\\node_modules\\react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "mes.jsx" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
		...
		_createClass(Item, [{
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						"a",
						{ href: "javascript:;", className: "btn_del", onClick: this.deleteItemHandle.bind(this) },
						"删除"
					)
				);
			}
		}, {
			key: "deleteItemHandle",
			value: function deleteItemHandle() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "body, h1, h2, h3, h4, h5, h6, hr, p, blockquote, dl, dt, dd, ul, ol, li, pre, form, fieldset, legend, button, input, textarea, th, td,b {\n    margin: 0; padding: 0;}\nbody, html{position:relative;margin:0 auto;}\n/*reset\nhtml,body,p,h1,h2,h3,h4,h5,h6,form,input,textarea,select,button,fieldset,legend,img,ul,ol,li,dl,dt,dd,th,td,pre,blockquote{margin:0;padding:0;}*/\nhtml{height:100%; -webkit-text-size-adjust:100%; -ms-text-size-adjust:100%; -webkit-font-smoothing:antialiased;}\nbody{min-height:100%;height:auto!important; height:100%;}\nbody,button,input,select,textarea,h1,h2,h3,h4,h5,h6{font-family:\"Microsoft Yahei\",simhei,sans-serif;}\ntable{border-collapse:collapse; border-spacing:0;}\nstrong,b{font-weight:normal;}\nem,i{font-style:normal;}\niframe{display:block;}\nsup{vertical-align:text-top;}\nsub{vertical-align:text-bottom;}\ns{text-decoration:none;}\nimg{height:auto;vertical-align:top;border:0 none;outline:none;}\ninput[type=\"submit\"],input[type=\"text\"],input[type=\"tel\"],input[type=\"number\"],input[type=\"button\"],input[type=\"password\"]{-webkit-appearance:none;appearance:none;-webkit-tap-highlight-color:rgba(0, 0, 0, 0);-webkit-tap-highlight-color:transparent;line-height:normal;}\ninput,label,button,textarea,select{border:medium none;font-family:\"microsoft yahei\";}\narticle,aside,details,figcaption,figure,footer,header,hgroup,menu,nav,section,summary,time,mark,audio,video {display:block;margin:0;padding:0;outline: 0;}\naudio,canvas,video{display:inline-block;*display:inline;*zoom:1;}\naudio:not([controls]){display:none;}\nh1, h2, h3, h4, h5, h6 {font-size: 100%;font-weight:normal;}\ninput:focus{outline:0;}\na:active,a:focus{outline:0;}\na{text-decoration: none;}\nul, ol, li { list-style: none outside none;}\ninput[type=checkbox],input[type=radio] {\n\tvertical-align:middle;\n}\n::-webkit-input-placeholder { /* WebKit browsers */\n    color:#999;\n}\n:-moz-placeholder { /* Mozilla Firefox 4 to 18 */\n    color:#999;\n}\n::-moz-placeholder { /* Mozilla Firefox 19+ */\n    color:#999;\n}\n:-ms-input-placeholder { /* Internet Explorer 10+ */\n    color:#999;\n}\ntextarea {\n\toverflow:auto;\n\tfont:100% tahoma,\\5b8b\\4f53,arial;\n}\ntable {\n    border-collapse: collapse;\n    border-spacing: 0;\n}\n.tc{\n\ttext-align: center;\n}\n.tl{\n\ttext-align: left;\n}\n.tr{\n\ttext-align: right;\n}\n.fl{float: left;\t}\n.fr{float: right;\t}\n.fn{float: none;\t}\n.cp{cursor: pointer;}\n\n.clearfix:after {\n    content:'';\n    display:block;\n    height:0;\n    clear:both;\n}\n.dis{display:none}\n.clearfix {\n    *zoom:1;\n}\n.bl{display: inline-block;}\n/*定位*/\n.rel{position: relative;}\n.abs{position: absolute;}\n.allvert *{vertical-align:middle}\n/*margin*/\n.mo{margin:0 auto;}\n.fwb{font-weight:bold;}\ninput[type=\"search\"]::-webkit-search-cancel-button,\ninput[type=\"search\"]::-webkit-search-decoration {\n    -webkit-appearance: none;\n}\ntextarea {\n    overflow: auto; /* 1 */\n    vertical-align: top; /* 2 */\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".mainblock,.list-area{width:600px;margin:0 auto}\n.field{margin-top:20px}\n.field {font-size:14px;line-height:20px;color:#000}\n.field  span{display:inline-block;width:60px}\n.input_tx{border:1px solid #ccc;padding:2px 5px}\n.btn_tijiao{padding:2px 5px;background:#ccc;border:1px solid #333;cursor:default}\n.list-area h3{font-size:18px;line-height:24px;margin-top:20px}\n.list-area ul li{margin:20px 0 0 20px;position:relative}\n.list-area ul h5{font-size:16px;line-height:20px;color:#666}\n.list-area ul p{font-size:14px;line-height:18px;color:#333;margin-top:10px}\n.btn_del{position:absolute;top:0px;right:0;border:1px solid blue;color:blue;font-size:14px;line-height:20px;padding:0 3px}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;/* REACT HOT LOADER */ if (false) { (function () { var ReactHotAPI = require("D:\\reactWorkspace\\liuyanben-难叔\\node_modules\\react-hot-api\\modules\\index.js"), RootInstanceProvider = require("D:\\reactWorkspace\\liuyanben-难叔\\node_modules\\react-hot-loader\\RootInstanceProvider.js"), ReactMount = require("react/lib/ReactMount"), React = require("react"); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } try { (function () {
